...
class deepgazeConfig(object):
    ...
    def __init__(self):
        ...
        self.label_dir = '/content/drive/MyDrive/7Channel/Salicon/fixations/'
        self.label_json = '/content/drive/MyDrive/7Channel/Salicon/fixations/fixations_train2015r1.json'
